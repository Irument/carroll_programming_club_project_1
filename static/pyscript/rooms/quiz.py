...
class Room(rooms.BaseRoom):
    ...
    def create_question_boxes(self):
        ...
        self.canvas.add_button(0, self.canvas.canvas.height/2, self.canvas.canvas.width/2, self.canvas.canvas.height/4, '/static/img/answer_box.png', self.answer_box_callbacks.topleft)
        self.canvas.add_button(self.canvas.canvas.width/2, self.canvas.canvas.height/2, self.canvas.canvas.width/2, self.canvas.canvas.height/4, '/static/img/answer_box.png', self.answer_box_callbacks.topright)
        self.canvas.add_button(0, self.canvas.canvas.height/2+(self.canvas.canvas.height/4), self.canvas.canvas.width/2, self.canvas.canvas.height/4, '/static/img/answer_box.png', self.answer_box_callbacks.bottomleft)
        self.canvas.add_button(self.canvas.canvas.width/2, self.canvas.canvas.height/2+(self.canvas.canvas.height/4), self.canvas.canvas.width/2, self.canvas.canvas.height/4, '/static/img/answer_box.png', self.answer_box_callbacks.bottomright)
